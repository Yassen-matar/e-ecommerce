...
class SignUpBloc extends Bloc<SignUpEvent, SignUpState> {
  ...
  SignUpBloc(this.postSignUpUseCase,this.postSignUpWithGoogleUseCase) : super(SignUpInitial()) {
  ...
  Future _signUpWithGoogle(
    ...
    emit(SignUpLoding());
    final Either<Failure, UserEntity> result = await postSignUpWithGoogleUseCase.call(
      );
    result.fold((failure) => emit(SignUpFailure(failure.message)),
